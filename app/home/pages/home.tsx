 ...
 *
 * Composes the 8-section bento per REQ-HOME-2:
 *   1. HeroProfileCard (top)
 *   2. MetricsBento (3-cell metrics row)
 *   3. SelectedWorksBento (3-cell featured projects)
 *   4. ExpandedAboutBento (About)
 *   5. MethodologyBento (Understand, Plan, Act)
 *   6. TestimonialsSplit (reviews split)
 *   7. ContactCTA (real form, not a CTA — REQ-HOME-6)
 *   8. PublicFooter + BottomNavDock (mobile)
 *
...
import { MethodologyBento } from '~/home/molecules/methodology-bento';
